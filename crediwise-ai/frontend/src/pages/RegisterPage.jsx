    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.logoWrap}>
          ...
          <p style={styles.subtitle}>Start maximizing your rewards today</p>
        </div>
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.group}>
            <label style={styles.label}>Full Name</label>
            <input style={styles.input} type="text" placeholder="Jane Doe" value={form.name} onChange={e=>setForm({...form,name:e.target.value})} required/>
          </div>
          <div style={styles.group}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
            <div style={styles.group}>
              ...
              <input style={styles.input} type="password" placeholder="Min. 6 chars" value={form.password} onChange={e=>setForm({...form,password:e.target.value})} required/>
            </div>
            <div style={styles.group}>
          ...
          <p style={styles.link}>Already have an account? <Link to="/login" style={{color:'var(--gold-bright)'}}>Sign in</Link></p>
        </form>
      </div>
    </div>
  )
...
const styles = {
  ...
  card:{background:'var(--bg-surface)',border:'1px solid var(--gold-dim)',borderRadius:16,padding:'40px 36px',maxWidth:440,width:'100%'},
