...
def boardroom():
    ...
    """
    body = request.get_json(silent=True) or {}
    app.logger.error(f"DEBUG: boardroom received body: {body}")
    ...
    # Resilience: If frontend sends a list (raw rows), convert to empty dict 
    # to avoid 400. Proper fix is on frontend, but this prevents crash.
